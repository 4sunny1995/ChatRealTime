        ...
        <div class="chat">
            ...
            <div class="messages">
                <div class="messages-content">
                    <ChatItem v-for="(item,index) in listMessages" :key="index" :message="item"></ChatItem>
                </div>
            </div>
        ...
        async sendMessage(){
            try
            {
                var body  = {
                    ...
                    "user_id":this.currentUserLogin.id,
                    "group_id":"all"
                }
                const response = await axios.post('/chat/messages',body)
                this.listMessages.push(response.data)
                this.message=""
            }
            catch(error)
            {
